...
public final class EventHandler implements Runnable
{
  ...
  static final Class[] eventTypes = 
  {
    Event.class,
    LocatableEvent.class,
    VMStartEvent.class,
    VMDeathEvent.class,
    VMDisconnectEvent.class,
    ThreadStartEvent.class,
    ThreadDeathEvent.class,
    ClassPrepareEvent.class,
    ClassUnloadEvent.class,
    BreakpointEvent.class,
    WatchpointEvent.class,
    ExceptionEvent.class,
    StepEvent.class,
    MethodEntryEvent.class,
    MethodExitEvent.class,
  };

  static final boolean[] suspendStatus =
  {
    false,
    true,
    false,
