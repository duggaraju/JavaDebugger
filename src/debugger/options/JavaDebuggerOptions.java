...
public class JavaDebuggerOptions extends AbstractOptionPane implements DebuggerOptions
{
  ...
  {
    TitledBorder border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), jEdit.getProperty(title));
    return border;
  }
  ...
  protected void _init()
  {
    ...
    vmSetButton.addActionListener(new ActionListener() {
      ...
      {
        String[] entries =
          GUIUtilities.showVFSFileDialog(jEdit.getActiveView(), null, VFSBrowser.OPEN_DIALOG, false);
