...
/**
 * Represents an Application being Debugged.
 * Stores the necessary information about the application.
 * like which Virtual Machine to use, Classpath etc.
 */
...
public final class Application implements DebuggerOptions
{
  ...
  public synchronized final void addEventRequest(EventSpec event)
  {
    ...
    ApplicationListener[] listeners = 
      (ApplicationListener[]) listenerList.getListeners(ApplicationListener.class);
